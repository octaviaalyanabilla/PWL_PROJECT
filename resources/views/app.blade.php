...
<html lang="en">
  <head>
    ...
    <title>@yield('title') | Sistem Pergudangan</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">Pergudangan</a>
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="{{asset('image/jum.png')}}" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Rifki</p>
          <p class="app-sidebar__user-designation">Bella</p>
        </div>
      </div>
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item @yield('pegawai')" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Pegawai</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="{{route('barang.index')}}"><i class="icon fa fa-circle-o"></i> Data Barang Masuk</a></li>
            <li><a class="treeview-item" href="{{route('barang.create')}}" target="" rel="noopener"><i class="icon fa fa-circle-o"></i> Tambah Barang</a></li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Rekap Data</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            ...
            <li><a class="treeview-item" href="{{route('barang-pdf')}}"><i class="icon fa fa-circle-o"></i> Barang</a></li>
          </ul>
        </li>
      </ul>
    </aside>
